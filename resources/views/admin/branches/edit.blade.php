    ...
    <form action="{{ route('admin.branches.update', $branch) }}"
        ...
        <div class="bg-white
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Branch code must be unique within the selected company.
                        </p>
            ...
            <div class="flex flex-col
                ...
                <button   type="submit"   class="px-5 py-2.5 bg-indigo-600  text-white   rounded-lg hover:bg-indigo-700  transition" >
                    Update Branch
                </button>
            </div>
        </div>
